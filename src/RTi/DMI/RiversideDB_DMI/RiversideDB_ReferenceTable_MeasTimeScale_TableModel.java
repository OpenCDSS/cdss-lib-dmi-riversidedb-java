...
//------------------------------------------------------------------------------
// RiversideDB_ReferenceTable_MeasTimeScale_TableModel - Table model used for
// 	displaying thw data editor for the reference table MeasTimeScale.
...
/**
Table model used for displaying thw data editor for the table MeasTimeScale.
This class extends from RiversideDB_ReferenceTable_Abstract_TableModel.
*/
public class RiversideDB_ReferenceTable_MeasTimeScale_TableModel
...
public final static int
	...
	COL_MEAS_TIME_SCALE_SCALE       = 0,
	COL_MEAS_TIME_SCALE_DESCRIPTION = 1,
	NUMBER_OF_COLUMNS               = 2;
...
{
	RiversideDB_MeasTimeScale current =
		(RiversideDB_MeasTimeScale) currentObject;
	RiversideDB_MeasTimeScale original =
		(RiversideDB_MeasTimeScale) originalObject;
...
{
	switch ( column ) {
		case COL_MEAS_TIME_SCALE_SCALE:	      return String.class;
		case COL_MEAS_TIME_SCALE_DESCRIPTION: return String.class;
...
{
	switch ( column ) {	
		case COL_MEAS_TIME_SCALE_SCALE:       return "Scale";
		case COL_MEAS_TIME_SCALE_DESCRIPTION: return "Description";	
		default: return " ";
	}
}
...
public String[] getColumnToolTips()
{
	...
	tips[COL_MEAS_TIME_SCALE_SCALE]       = "MeasTimeScale.Scale";
	tips[COL_MEAS_TIME_SCALE_DESCRIPTION] = "MeasTimeScale.Description";
...
public int[] getColumnWidths()
{
	...
	widths[COL_MEAS_TIME_SCALE_SCALE]       = 15;
	widths[COL_MEAS_TIME_SCALE_DESCRIPTION] = 35;
...
{
	switch ( column ) {
		case COL_MEAS_TIME_SCALE_SCALE:		return "%-20s";
		case COL_MEAS_TIME_SCALE_DESCRIPTION:	return "%-20s";
		default:				return "%-20s";
	}
}
...
protected Object getTableValueAt( int row, int column )
{
	...
	switch (column) {
		case COL_MEAS_TIME_SCALE_SCALE:
			return m.getScale();
		case COL_MEAS_TIME_SCALE_DESCRIPTION:
