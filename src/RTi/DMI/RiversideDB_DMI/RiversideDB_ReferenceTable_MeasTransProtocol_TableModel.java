...
//------------------------------------------------------------------------------
// RiversideDB_ReferenceTable_MeasTransProtocol_TableModel - Table model used for
// 	displaying thw data editor for the reference table MeasTransProtocol.
...
/**
Table model used for displaying thw data editor for the table MeasTransProtocol.
This class extends from RiversideDB_ReferenceTable_Abstract_TableModel.
*/
public class RiversideDB_ReferenceTable_MeasTransProtocol_TableModel
...
public final static int
	COL_MEAS_TRANS_PROTOCOL_PROTOCOL    = 0,
	COL_MEAS_TRANS_PROTOCOL_DESCRIPTION = 1,
	NUMBER_OF_COLUMNS                   = 2;
...
{
	RiversideDB_MeasTransProtocol current =
		(RiversideDB_MeasTransProtocol) currentObject;
	RiversideDB_MeasTransProtocol original =
		(RiversideDB_MeasTransProtocol) originalObject;
...
{
	switch ( column ) {
		case COL_MEAS_TRANS_PROTOCOL_PROTOCOL:	 return String.class;
		case COL_MEAS_TRANS_PROTOCOL_DESCRIPTION:return String.class;
...
{
	switch ( column ) {
		case COL_MEAS_TRANS_PROTOCOL_PROTOCOL:   return "Protocol";
		case COL_MEAS_TRANS_PROTOCOL_DESCRIPTION:return "Description";
		default:                                 return " ";
	}
}
...
public String[] getColumnToolTips()
{
	...
	tips[COL_MEAS_TRANS_PROTOCOL_PROTOCOL]    = "MeasTransProtocol.Protocol";
	tips[COL_MEAS_TRANS_PROTOCOL_DESCRIPTION] = "MeasTransProtocol.Description";
...
public int[] getColumnWidths()
{
	...
	widths[COL_MEAS_TRANS_PROTOCOL_PROTOCOL]    =  6;
	widths[COL_MEAS_TRANS_PROTOCOL_DESCRIPTION] = 50;
...
{
	switch ( column ) {
		case COL_MEAS_TRANS_PROTOCOL_PROTOCOL:	 return "%-20s";
		case COL_MEAS_TRANS_PROTOCOL_DESCRIPTION:return "%-20s";
		default:				 return "%-20s";
	}
}
...
protected Object getTableValueAt( int row, int column )
{
	...
	switch (column) {
		...
		case COL_MEAS_TRANS_PROTOCOL_DESCRIPTION:
