...
// ----------------------------------------------------------------------------
// RiversideDB_MeasType.java - class to store MeasType/MeasLoc data
// ----------------------------------------------------------------------------
// Copyright:   See the COPYRIGHT file
// ----------------------------------------------------------------------------
// History:
// 2002-05-21	J. Thomas Sapienza, RTi	Initial Version
// 2002-05-22	JTS, RTi		Initialize variables to "missing"
//					values.  Added methods to check for 
//					null strings and make them missing 
//					strings.  Added function to fill this 
//					object in from a row in a record set.
//					STRING_NA became MISSING_STRING.
//					Javadoc'd.
// 2002-05-23	JTS, RTi		Added missing methods for MeasType_num
//					Added fillObjectVector method.
// 2002-05-29	JTS, RTi 		Added __dirty variable and methods
// 2002-06-06	Steven A. Malers, RTi	Add toTSIdent() method.
// 2002-06-25	SAM, RTi		Move ResultSet conversion logic to the
//					RiversideDB_DMI class.  Simplify this
//					class.  Extend from DMIDataObject for
//					"dirty" functionality.
...
// 2003-06-05	JTS, RTi		* Added the IsVisible field.
//					* Added DBUser_num, DBGroup_num, 
//					  DBPermissions fields.
//					* Added TS_DBUser_num, TS_DBGroup_num, 
//					  TS_DBPermissions fields.
// 2005-01-04 Luiz Teixeira, RTi	Added the _IsEditable member used under
//          				_VERSION_030000_20041001 and the 
//					methods getIsEditable and setIsEditable.
//					This member and methods replace the pre
//					03.00.00 _Editable and methods getEditable
//					and setEditable. Some cleanup...
// ----------------------------------------------------------------------------
...
/**
class to store data from the MeasType table
*/
public class RiversideDB_MeasType extends DMIDataObject
{
...
throws Throwable
{
	...
	_Data_type        = null;
	_Sub_type         = null;
	_Time_step_base   = null;
	_Source_abbrev    = null;
	_Scenario         = null;
	_Description      = null;
	_Units_abbrev     = null;
	_Create_method    = null;
	_TransmitProtocol = null;
	_Status           = null;
	_Editable         = null;                                // pre 03.00.00
	_IsEditable       = null;                                //     03.00.00
	_IsVisible        = null;
	_DBPermissions    = null;
	_TS_DBPermissions = null;

	super.finalize();
}

//   Get snd set methods presented in alphabetic order.
// ----------------------------------------------------
