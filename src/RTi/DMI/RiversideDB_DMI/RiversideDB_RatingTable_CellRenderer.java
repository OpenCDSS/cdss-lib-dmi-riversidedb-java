// ----------------------------------------------------------------------------
// RiversideDB_RatingTable_CellRenderer - Class for rendering cells 
//	for a table that contains information from 2 tables:
//	StageDischargeRating and RatingTable.
// ----------------------------------------------------------------------------
...
in Reductions
*/
public class RiversideDB_RatingTable_CellRenderer
extends JWorksheet_AbstractExcelCellRenderer {

/**
The table model for which this class will render cells.
*/
private RiversideDB_RatingTable_TableModel __tableModel;

/**
Constructor.  
@param tableModel the table model for which to render cells
*/
public RiversideDB_RatingTable_CellRenderer(
	RiversideDB_RatingTable_TableModel tableModel) {
