// ----------------------------------------------------------------------------
// RiversideDB_ImportConf_CellRenderer - Class for rendering cells 
//	for a table that contains information from 2 tables:
//	ImportConf and MeasType (the TSID).
// ----------------------------------------------------------------------------
...
/**
This class is used to render cells for Import Conf data and TSID of
Imported Time Series.
*/
public class RiversideDB_ImportConf_CellRenderer
extends JWorksheet_AbstractExcelCellRenderer {

/**
The table model for which this class will render cells.
*/
private RiversideDB_ImportConf_TableModel __tableModel;

/**
Constructor.  
@param tableModel the table model for which to render cells
*/
public RiversideDB_ImportConf_CellRenderer(
	RiversideDB_ImportConf_TableModel tableModel) {
